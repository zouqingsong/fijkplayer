 ...
 * - befovy.com/fijk: Production API for mobile_fijk_player (backward compatible)
...
public class FijkPlugin implements FlutterPlugin {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        ...
        productionChannel = new MethodChannel(
        ...
        recorderChannel = new MethodChannel(
            binding.getBinaryMessenger(),
        ...
        ffmpegKitChannel = new MethodChannel(
            binding.getBinaryMessenger(),
        ...
        android.util.Log.i(TAG, "✅ FijkPlugin attached - All 4 channels registered:");
